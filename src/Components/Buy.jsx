  ...
  return (
    <section className="w-full bg-[whitesmoke]">
      <div className="max-w-7xl mx-auto leading-9 flex flex-col justify-center items-center py-20">
        <p className="navColor howToBuy text-5xl font-bold">HOW TO BUY $ETHEREUM</p>

        <div className="block px-4 md:px-0 md:flex items-center pt-8 gap-4">
          <div className="mb-8 px-4 p-4 shadow-2xl rounded-md md:mb-0 buy_box">
          ...
          <div className="px-4 p-4 shadow-2xl rounded-md buy_box">
            <p className="font-bold text-[1.25rem] text-center">3. SWAP $ETHEREUM</p>
            <p className="pt-4 text-center px-8">
